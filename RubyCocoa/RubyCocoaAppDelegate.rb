#  RubyCocoaAppDelegate.rb
#  RubyCocoa
#
#  Created by Aaron VonderHaar on 1/26/09.
...
class AppDelegate < OSX::NSObject
  ...
  def applicationSupportFolder
    OSX.NSHomeDirectory.stringByAppendingPathComponent(File.join('Library', 'Application Support', 'RubyCocoa'))
  end
  ...
  def managedObjectContext
    ...
    url = OSX::NSURL.fileURLWithPath(storeFolder.stringByAppendingPathComponent("RubyCocoa.xml"))
